<h2 class="route-edit-title">✏️ Editar ruta #<?= htmlspecialchars($item['id'] ?? '') ?></h2>

<form method="post" action="<?= $base ?>/routes/update" class="form route-edit-form" autocomplete="off">
