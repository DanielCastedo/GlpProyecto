<style>
  ...
  .panel-welcome .btn:hover,
  .panel-welcome .btn:focus {
    background: #135ba1;
  }
</style>
...
<div class="panel-welcome">
  ...
  <div class="quick-actions">
    <div class="quick-actions">
      ...
      <a class="btn" href="<?= $base ?>/trucks">Camiones</a>
      <a class="btn" href="<?= $base ?>/routes">Rutas</a>
      <a class="btn" href="<?= $base ?>/schedules">Horarios</a>
      <a class="btn" href="<?= $base ?>/purchases">Compras</a>
      <a class="btn" href="<?= $base ?>/inventory_movements">Movimientos de Inventario</a>
    </div>
  </div>
</div>