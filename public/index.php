...
session_start(); // 🔐 Asegura que la sesión siempre esté activa
...
// Si no hay sesión y no está en rutas públicas → redirigir al login
if (!in_array($current, $publicRoutes) && empty($_SESSION['user'])) {
    header('Location: ' . $basePath . '/login');
    exit;
}

// Despachar todas las rutas
$router->dispatch();
