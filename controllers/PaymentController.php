...
class PaymentController extends Controller {
    ...
    public function create(){
        ...
        $this->render('payments/create', compact('sale_id'));
    }
    ...
    public function edit(){
        ...
        if (!$item) { echo "<p>Pago no encontrado</p>"; return; }
    ...
    private function recalcSalePaid(int $sale_id): void {
        ...
        $upd = $pdo->prepare("UPDATE sales SET amount_paid = ?, balance_due = ? WHERE id = ?");
        $upd->execute([$paid, $balance, $sale_id]);
    }
}
